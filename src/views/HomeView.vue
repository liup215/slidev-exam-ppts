            ...
            >
              ...
              <div class="chapter-actions">
                <a
                  v-if="chapter.url !== '#'"
                  :href="chapter.url"
                  class="chapter-btn ppt-btn"
                  title="查看幻灯片"
                >🖼 PPT</a>
                <RouterLink
                  v-if="hasNote(currentBoard!.id, currentGroup!.id, chapter.id)"
                  :to="`/notes/${currentBoard!.id}/${currentGroup!.id}/${chapter.id}`"
                  class="chapter-btn note-btn"
                  title="查看笔记"
                >📄 笔记</RouterLink>
              </div>
            </div>
